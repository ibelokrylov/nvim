    ...
    keys = {
      ...
      },
      {
        ...
        function()
          local builtin = require 'telescope.builtin'
          builtin.find_files {
            find_command = { 'rg', '--files', '--no-ignore', '--hidden' }, -- Использование ripgrep для быстрого поиска
            prompt_title = 'Find all files', -- Название строки поиска
            hidden = true, -- Поиск скрытых файлов
            layout_strategy = 'horizontal', -- Стратегия размещения результатов
          }
        end,
        desc = 'Lists files in your current working directory, respects .gitignore',
      },
      ...
      },
      {
        ...
        desc = 'Search for string under cursor in current working directory, respects .gitignore',
      },
      {
        '\\\\',
        function()
